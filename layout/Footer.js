  ...
  return (
    <footer className="main-footer bgc-blue   rel z-1">
      ...
      <div className="container">
          ...
          <div className="col-xl-12 col-12">
            <div className="footer-text">
              <div>
                ...
                <h2 className="text-white">LET'S MOVE FREIGHT  <br />SMATER.</h2>
                <p>Whether you're shipping local or long haul, we’re readyto roll.  <br />Contact us today to request a quote or speak with our team.</p>
              </div>
              <div>
            ...
            <div className="footer-text  ">
              <div>
                <h5 className="text-white new-font">Main Office:</h5>
                <p>1511 S Miles Ave Apt 211, Lodi, CA 95242
                </p>
                <h5 className="text-white new-font ">Mailing Address:</h5>
                <p>6507 Pacific Ave PMB 294, Stockton, CA 95207
                </p>
              </div>
              <div>
                <div className="footer-text-style">
                  <h5 className="text-white m-0">Phone:</h5>
                  <p className="m-0"> <Link href="tel:209-470-7250">  209-470-7250 </Link>
                  </p>
                </div>
                <div className="footer-text-style">
                  <h5 className="text-white m-0 new-font">Email (Operations):</h5>
                  <p className="m-0"><Link href="mailto:support@dadson.us" >support@dadson.us</Link>
                  </p>
                </div>
                <div className="footer-text-style">
                  <h5 className="text-white m-0 new-font">Billing & Remittance:</h5>
                  <p className="m-0"><Link href="mailto:ar@dadson.us" >ar@dadson.us</Link>
                  </p>
                </div>
              </div>
              <div>
                <h5 className="text-white ">Office Hours:</h5>
                <div className="footer-text-style">
                  <h5 className="text-white m-0 new-font">Monday–Friday:</h5>
                  <p className="m-0">8:00 AM – 5:00 PM PST
                  </p>
                </div>
                <div className="footer-text-style">
                  <h5 className="text-white m-0 new-font">Saturday & Sunday:</h5>
                  <p className="m-0">By appointment
                  </p>
                </div>
              </div>
            </div>
            <div className="col-xl-12 col-12">
              <div className="footer-new-logo text-center">
                <Link href="/">
                <img
                  src="/assets/images/logos/logo-2.png" className="footer-img-logo"
                  alt="Logo"
                  title="Logo"
                />
                </Link>
        ...
        <div className="col-xl-12 col-12 mt-30">
          <div className="container">
            <div className="row">
            <div className="footer-text">
            <div>
          ...
          <div className="row">
            <div className="col-lg-6">
              <div className="copyright-text">
                <p>
                  Copyright © 2025 <Link href="/">Dadson</Link>, All Rights
                  Reserved.
                </p>
              </div>
            </div>
          ...
          <div className="row">
            ...
            <div className="col-md-9 text-center text-lg-end">
              <div className="copyright-text text-center text-md-end">
                <p>
                  Copyright © <Link href="/">Dadson</Link>, all rights
                  reserved.
                </p>
              </div>
            </div>
          ...
          <div className="row align-items-center">
            ...
            <div className="col-lg-4">
              <div className="copyright-text text-lg-end wow fadeInLeft delay-0-2s">
                <p>© 2025 Dadson. All rights reserved.</p>
              </div>
            </div>
          </div>
        </div>
